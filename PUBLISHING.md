...
- Fabric/Quilt required: Fabric API and Cloth Config
...
6. Create separate Modrinth version records for Fabric/Quilt and NeoForge so launchers receive the correct artifact.
